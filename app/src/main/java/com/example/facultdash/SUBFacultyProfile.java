...
public class SUBFacultyProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seeProfileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog dialog = new Dialog(SUBFacultyProfile.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);

                // Set the image resource to the ImageView in the dialog.
                ImageView fullscreenImageView = new ImageView(SUBFacultyProfile.this);
                ...
                fullscreenImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Animation animation = AnimationUtils.loadAnimation(SUBFacultyProfile.this, R.anim.dialog_exit_animation);
        ...
        editProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), SUBFacultyProfileEdit.class)); // Replace with the correct activity name.
            }
        });
