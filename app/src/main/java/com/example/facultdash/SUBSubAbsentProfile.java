...
public class SUBSubAbsentProfile extends AppCompatActivity {
    String fnm, femail;
    ImageView i66;
    ...
    private void getFacultyChildren(String USERID) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(SUBSubAbsentProfile.this, "Error: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void loadInSpinner() {
        spinnerAdapter = new ArrayAdapter<>(SUBSubAbsentProfile.this, android.R.layout.simple_spinner_item, childNames);
    ...
    private void getStudentDetails(String userid) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(SUBSubAbsentProfile.this, "No data found", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        i66.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog dialog = new Dialog(SUBSubAbsentProfile.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);

                // Set the image resource to the ImageView in the dialog.
                ImageView fullscreenImageView = new ImageView(SUBSubAbsentProfile.this);
                ...
                fullscreenImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Animation animation = AnimationUtils.loadAnimation(SUBSubAbsentProfile.this, R.anim.dialog_exit_animation);
