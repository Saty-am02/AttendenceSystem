...
public class SUBStudentFacultyView extends AppCompatActivity {
    SUBSubjectAdapter SUBSubjectAdapter;
    RecyclerView recyclerView;
    String facultyid;
    String facultyName,facultyEmail,facultyProgram,facultyuniqueID;
    ArrayList<SUBSubjectListItem>  listFacultySubjects ;
                        ...
                        for (DataSnapshot facultySnapshot : snapshot.getChildren()) {
                            ...
                            if (facultySnapshot.getKey().equals(facultyid)) {
                                ...
                                for(String subject:facultySubjects){
                                    listFacultySubjects.add(new SUBSubjectListItem(subject)) ;
                                }
                                SUBSubjectAdapter =new SUBSubjectAdapter(getApplicationContext(),listFacultySubjects);
                                recyclerView.setAdapter(SUBSubjectAdapter);
