...
public class SUBFacultyListOfClass extends RecyclerView.Adapter<SUBFacultyListOfClass.MyViewHolder> {

    private Context context;
    private ArrayList<SUBFaculty> faculties;

    public SUBFacultyListOfClass(Context context, ArrayList<SUBFaculty> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        SUBFaculty flist = faculties.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, SUBStudentFacultyView.class);
